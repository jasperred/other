...
public class ShoppingCartPaymentMethodResponseEntityArray  implements java.io.Serializable {
    ...
    private Magento.AssociativeEntity[] cc_types;
    ...
    public ShoppingCartPaymentMethodResponseEntityArray(
           ...
           Magento.AssociativeEntity[] cc_types) {
           this.code = code;
           this.title = title;
     ...
     * @return cc_types
     */
    public Magento.AssociativeEntity[] getCc_types() {
        return cc_types;
    }
     ...
     * @param cc_types
     */
    public void setCc_types(Magento.AssociativeEntity[] cc_types) {
        this.cc_types = cc_types;
    }
