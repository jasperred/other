...
public class CatalogProductAdditionalAttributesEntity  implements java.io.Serializable {
    private Magento.AssociativeMultiArray multi_data;

    private Magento.AssociativeEntity[] single_data;

    public CatalogProductAdditionalAttributesEntity() {
    }

    public CatalogProductAdditionalAttributesEntity(
           Magento.AssociativeMultiArray multi_data,
           Magento.AssociativeEntity[] single_data) {
     ...
     * @return multi_data
     */
    public Magento.AssociativeMultiArray getMulti_data() {
        return multi_data;
    }
     ...
     * @param multi_data
     */
    public void setMulti_data(Magento.AssociativeMultiArray multi_data) {
        this.multi_data = multi_data;
    }
     ...
     * @return single_data
     */
    public Magento.AssociativeEntity[] getSingle_data() {
        return single_data;
    }
     ...
     * @param single_data
     */
    public void setSingle_data(Magento.AssociativeEntity[] single_data) {
        this.single_data = single_data;
    }
        ...
        _equals = true && 
            ((this.multi_data==null && other.getMulti_data()==null) || 
             (this.multi_data!=null &&
              this.multi_data.equals(other.getMulti_data()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getMulti_data() != null) {
            _hashCode += getMulti_data().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:Magento", "associativeMultiArray"));
