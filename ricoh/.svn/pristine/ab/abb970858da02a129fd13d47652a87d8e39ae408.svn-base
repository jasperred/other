...
<s:if test="resultList!=null&&resultList.size()>0">
	<s:iterator value="resultList" status="rl" id="result">
		<tr id="delivery_<s:property value='ServiceDeliveryId'/>">
			...
			<td>
				<a href="deliveryServiceInfoByScmAction.action?serviceDeliveryId=<s:property value="ServiceDeliveryId" />"><s:property value='ServiceDeliveryNo'/></a>
			</td>
			<td>
			...
			<td>
				<a href="deliveryServiceInfoByScmAction.action?serviceDeliveryId=<s:property value="ServiceDeliveryId" />">查看</a>
			</td>
		</tr>
	</s:iterator>
	<!-- 分页 -->
