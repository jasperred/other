...
<s:if test="resultList!=null&&resultList.size()>0">
	<s:iterator value="resultList" status="rl" id="result">
		<tr id="order_<s:property value='LocalOrderHeadId'/>">
			...
			<td>
				<a href="applyServiceInfoByShopAction.action?serviceApplyId=<s:property value="ServiceApplyId" />"><s:property value='ServiceApplyNo'/></a>
			</td>
			<td>
			...
			<td>
				<a href="applyServiceInfoByShopAction.action?serviceApplyId=<s:property value="ServiceApplyId"/>" >查看</a>
			</td>
		</tr>
	</s:iterator>
	<!-- 分页 -->
