...
<s:if test="resultList!=null&&resultList.size()>0">
	<s:iterator value="resultList" status="rl" id="result">
		<tr>
			...
			<td>
				<a href="invoiceInfoByRcnAction.action?invoiceId=<s:property value="InvoiceId" />"><s:property value='InvoiceCd'/></a>
			</td>
			<td>
			...
			<td>
				<a href="invoiceInfoByRcnAction.action?invoiceId=<s:property value="InvoiceId"/>" >查看</a>
			</td>
		</tr>
	</s:iterator>
	<!-- 分页 -->
