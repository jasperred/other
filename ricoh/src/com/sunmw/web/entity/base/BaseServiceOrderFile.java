...
/**
 * This is an object that contains data related to the service_order_file table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="service_order_file"
 */

public abstract class BaseServiceOrderFile  implements Serializable {

	public static String REF = "ServiceOrderFile";
	 ...
	 */
	public BaseServiceOrderFile (com.sunmw.web.entity.ServiceOrderFilePK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.sunmw.web.entity.ServiceOrderFilePK id;
     ...
     * @hibernate.id
     */
	public com.sunmw.web.entity.ServiceOrderFilePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.sunmw.web.entity.ServiceOrderFilePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.sunmw.web.entity.ServiceOrderFile)) return false;
		else {
			com.sunmw.web.entity.ServiceOrderFile serviceOrderFile = (com.sunmw.web.entity.ServiceOrderFile) obj;
			if (null == this.getId() || null == serviceOrderFile.getId()) return false;
			else return (this.getId().equals(serviceOrderFile.getId()));
		}
	}
