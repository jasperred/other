...
/**
 * This is an object that contains data related to the security_group_permission table.
...
public abstract class BaseSecurityGroupPermission  implements Serializable {

	public static String REF = "SecurityGroupPermission";
	...
	// constructors
	public BaseSecurityGroupPermission () {
		initialize();
	}
	 ...
	 */
	public BaseSecurityGroupPermission (com.sunmw.web.entity.SecurityGroupPermissionPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.sunmw.web.entity.SecurityGroupPermissionPK id;
     ...
     * @hibernate.id
     */
	public com.sunmw.web.entity.SecurityGroupPermissionPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.sunmw.web.entity.SecurityGroupPermissionPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.sunmw.web.entity.SecurityGroupPermission)) return false;
		else {
			com.sunmw.web.entity.SecurityGroupPermission securityGroupPermission = (com.sunmw.web.entity.SecurityGroupPermission) obj;
			if (null == this.getId() || null == securityGroupPermission.getId()) return false;
			else return (this.getId().equals(securityGroupPermission.getId()));
		}
	}
