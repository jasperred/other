...
/**
 * This is an object that contains data related to the service_delivery_file table.
...
public abstract class BaseServiceDeliveryFile  implements Serializable {

	public static String REF = "ServiceDeliveryFile";
	...
	// constructors
	public BaseServiceDeliveryFile () {
		initialize();
	}
	 ...
	 */
	public BaseServiceDeliveryFile (com.sunmw.web.entity.ServiceDeliveryFilePK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.sunmw.web.entity.ServiceDeliveryFilePK id;
     ...
     * @hibernate.id
     */
	public com.sunmw.web.entity.ServiceDeliveryFilePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.sunmw.web.entity.ServiceDeliveryFilePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.sunmw.web.entity.ServiceDeliveryFile)) return false;
		else {
			com.sunmw.web.entity.ServiceDeliveryFile serviceDeliveryFile = (com.sunmw.web.entity.ServiceDeliveryFile) obj;
			if (null == this.getId() || null == serviceDeliveryFile.getId()) return false;
			else return (this.getId().equals(serviceDeliveryFile.getId()));
		}
	}
