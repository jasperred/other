...
public class CompanyMachineTypeRefSearchAction {
...
private CompanyServices companyServices;
	...
	public String searchCompanyMachineTypeRef()
	{
		try {
			...
			Map r = this.companyServices.searchCompanyMachineTypeRef(param, currentPage, pageRow);
