				...
				<table width=100% id="order-search">
					...
					<tr>
						<td class="double-cols">
							<input type="text" class="pure-text" value="维修人姓名" readonly="readonly"/>:
					...
					<tr>
						...
						<td class="double-cols">
							<input type="text" class="pure-text" value="保修期" readonly="readonly"/>:
							<select name="" id="service-date-status">
									<option value="">
									</option>
									<option value="保修期内">保修期内</option>
									<option value="保修期外">保修期外</option>
									<option value="维护合同期">维护合同期</option>
							</select>
						</td>
					
						<td class="sdingle-col">
							<input type="text" class="pure-text" value="服务形式" readonly="readonly"/>:
							<select name="ShopCode" id="service-method">
									<option value="">
									</option>
									<option value="送修">送修</option>
									<option value="寄修">寄修</option>
					...
					<tr>
						<td class="double-cols">
							<input type="text" class="pure-text" value="维修合同形态" readonly="readonly"/>:
						...
						<td class="double-cols">
							<input type="text" class="pure-text" value="维修作业项目" readonly="readonly"/>:
							<select name="ShopCode" id="service-operation">
									<option value=""></option>
									<option value="定期检查">定期检查</option>
									<option value="修理">修理</option>
									<option value="定期修理">定期修理</option>
									<option value="继续作业">继续作业</option>
									<option value="更换零件">更换零件</option>
									<option value="送货">送货</option>
									<option value="说明">说明</option>
									<option value="合同签约">合同签约</option>
									<option value="安装机器">安装机器</option>
									<option value="搬回修理">搬回修理</option>
								</select>
						</td>
					
						
						<td class="sdingle-col">
							<input type="text" class="pure-text" value="送修人" readonly="readonly"/>:
							<input type="text" name="" id="customer-name" />
						</td>
					</tr>
					<tr>
						<td class="double-cols">
							<input type="text" class="pure-text" value="已过时日" readonly="readonly"/>:
							<input type="text" name="" id="thru-time" />
						</td>
						<td class="double-cols">
							<input type="text" class="pure-text" value="维修措施代码" readonly="readonly"/>:
							<input type="text" name="" id="action-no" />
						</td>
					
						<td class="double-cols">
							<input type="text" class="pure-text" value="故障现象代码" readonly="readonly"/>:
							<input type="text" name="" id="symptom-no" />
						</td>
					</tr>
					<tr>
						<td class="sdingle-col">
							<input type="text" class="pure-text" value="故障原因代码" readonly="readonly"/>:
							<input type="text" name="" id="cause-no" />
						</td>
						<td class="sdingle-col">
							<input type="text" class="pure-text" value="故障部位代码" readonly="readonly"/>:
							<input type="text" name="" id="location-no" />
						</td>
					
						<td class="double-cols">
							<input type="text" class="pure-text" value="维修单状态" readonly="readonly"/>:
					...
					<tr>
						<td class="double-cols" colspan="2">
							<input type="text" class="pure-text" value="更换零件/选购件/耗材编号" style="width:170px;" readonly="readonly"/>:
